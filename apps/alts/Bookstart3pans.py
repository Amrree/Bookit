...
class EnhanceChaptersSidebar(tk.Frame):
    def __init__(self, master, get_project_folder, terminal_log_callback, *args, **kwargs):
        ...
        self.enhance_btn = tk.Button(control_frame, text="Enhance Now", command=self.run_manual, font=("Helvetica Neue", 12), bg="#3da9fc", fg="#161821", activebackground="#232946", activeforeground="#fff")
        self.enhance_btn.pack(side="left", padx=6)
        self.refresh_btn = tk.Button(control_frame, text="Refresh", command=self.refresh_status, font=("Helvetica Neue", 12), bg="#232946", fg="#fff", activebackground="#3da9fc", activeforeground="#161821")
